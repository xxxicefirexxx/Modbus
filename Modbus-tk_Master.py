...
def main():
    ...
    try:
        ...
        master = modbus_tcp.TcpMaster(host='192.168.1.100') #Set Slave IP Address
        master.set_timeout(5.0)
        logger.info("connected")
        
        logger.info(master.execute(1, cst.READ_HOLDING_REGISTERS, 0, 5)) # Set Start Address & Block Size
